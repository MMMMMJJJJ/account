...
public class BaseServiceFacadeImpl implements BaseServiceFacade {
    ...
    public ArrayList<CodeDetailBean> findCodeDetailList(){
        ArrayList<CodeDetailBean> codeList=codeListApplicationService.findCodeDetailList();
        return codeList;
    }
    ...
    @Override
    public ArrayList<PeriodBean> getPeriodNoList(){//xplatform 쪽에서 배열로 요청 하더라.

        ArrayList<PeriodBean> periodNoList = baseApplicationService.getPeriodNoList();
    ...
    public ArrayList<CustomerBean> findCustomerList() {
        ...
        ArrayList<CustomerBean> codeList=codeListApplicationService.findCustomerList();
        return codeList;
    }
}